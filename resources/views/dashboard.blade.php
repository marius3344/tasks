    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="flex">
                    <div class="flex-auto text-2xl mb-4">Assignments List</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/assignment/{{$assignment->id}}" method="POST"><button type="submit" name="delete">Delete</button>@csrf</form>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
